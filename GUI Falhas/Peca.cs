...
namespace GUI_Falhas
{
    internal class Peca
    {
        ...
        public Peca()
        {
            this.dataProd = randomDate();
            this.horaProd = randomTime(dataProd);
            this.codigo = Code();
            this.tempoProd = random.Next(10, 51);
            this.resultadoTeste = random.Next(1, 7);
            this.datateste = randomTestDate(dataProd);
